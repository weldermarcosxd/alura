...
<body>
	...
	<h1>Produtos</h1>
	<h2>
		<fmt:message key="message.bem-vindo"/>
	</h2>
	<div id="mensagem"></div>
	<table width="100%">
		<tr>
	...
	<c:url value="/produto/formulario" var="addProduto" />
	<a href="${addProduto}">
		<fmt:message key="message.adicionar-produto"/>
	</a>
	
	<c:import url="../commons/rodape.jsp" />
</body>
</html>